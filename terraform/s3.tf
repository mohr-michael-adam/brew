...
resource "aws_s3_bucket_object" "festa_brew_blonde_lager_fall_2023_html_object" {
  bucket = aws_s3_bucket.brew_data_bucket.id
  key    = "Festa Brew Blonde Lager Fall 2023.html"
  source = "ui/Festa Brew Blonde Lager Fall 2023.html"
  content_type = "text/html"
}

resource "aws_s3_bucket_object" "festa_brew_red_ale_fall_2023_html_object" {
  bucket = aws_s3_bucket.brew_data_bucket.id
  key    = "Festa Brew Red Ale Fall 2023.html"
  source = "ui/Festa Brew Red Ale Fall 2023.html"
  content_type = "text/html"
}

resource "aws_s3_bucket_object" "festa_brew_dry_lager_april_2024_html_object" {
  bucket = aws_s3_bucket.brew_data_bucket.id
  key    = "Festa Brew Dry Lager April 2024.html"
  source = "ui/Festa Brew Dry Lager April 2024.html"
  content_type = "text/html"
}

resource "aws_s3_bucket_object" "festa_brew_cream_ale_may_2024_html_object" {
  bucket = aws_s3_bucket.brew_data_bucket.id
  key    = "Festa Brew Cream Ale May 2024.html"
  source = "ui/Festa Brew Cream Ale May 2024.html"
  content_type = "text/html"
}

resource "aws_s3_bucket_object" "festa_brew_red_ale_spring_2025_html_object" {
  bucket = aws_s3_bucket.brew_data_bucket.id
  key    = "Festa Brew Red Ale Spring 2025.html"
